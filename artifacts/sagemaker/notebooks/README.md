...
```text
processed/matching/merge_pairs_sagemaker/run_date=...
processed/matching/eyeball_pairs_sagemaker/run_date=...
processed/matching/unique_records_sagemaker/run_date=...
...
processed/matching/merge_review_sagemaker/run_date=...
processed/matching/eyeball_review_sagemaker/run_date=...
```

For CR2, `unique_records_sagemaker` includes the best sub-threshold candidate
details when a record was blocked and evaluated but remained classified as
UNIQUE. This does not change matching scores, thresholds, blocking, or
